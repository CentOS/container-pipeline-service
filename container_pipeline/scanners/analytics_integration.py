#!/usr/bin/python
"""Analytics integration Scan Class."""
...
class AnalyticsIntegration(object):
    """scanner-analytics-integration atomic scanner handler."""

    def __init__(self):
        """AnalyticsIntegration initialization."""
        self.scanner_name = "scanner-analytics-integration"
        self.full_scanner_name = \
            "registry.centos.org/pipeline-images/scanner-analytics-integration"
    ...
    def scan(self, image_under_test):
        """
        Run the scanner-analytics-integration atomic scanner.
