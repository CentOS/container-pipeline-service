...
import ccp.lib.processors.index.project
...
class TestProject(unittest.TestCase):
    ...
    def test_load_entries(self):
        ...
        """
        obj = ccp.lib.processors.index.project.Project(self.entry, self.namespace)
        self.assertTrue(isinstance(obj,
                                   ccp.lib.processors.index.project.Project))

    def test_string_representation(self):
        """
        IndexReader: Tests __str__ representation of Project object
        """
        project = ccp.lib.processors.index.project.Project(self.entry, self.namespace)
        self.assertEqual(
            "foo-bar-latest",
            project.__str__()
        )
    ...
    def test_get_pipeline_name_3(self):
        ...
        with self.assertRaises(InvalidPipelineName):
            ccp.lib.processors.index.project.Project(self.entry, self.namespace)
