...
from ccp.apis.v1.server.ccp_server.models.meta import Meta  # noqa: F401,E501
from ccp.apis.v1.server.ccp_server.models.project_weekly_scan_builds import \
...
class WeeklyScanBuildsInfo(Model):
    ...
    def __init__(self, meta: Meta = None,
                 wscan_builds: ProjectWeeklyScanBuilds = None):  # noqa: E501
