...
class ProjectsValidationTests(IndexCIBase):
    ...
    def test_01_top_level_validator_fails_missing_project(self):
        self.assertFalse(
    ...
    def test_02_top_level_validator_fails_projects_not_list(self):
        self.assertFalse(
            schema_validation.TopLevelProjectsValidator(
                {
    ...
    def test_03_top_level_validator_success_valid_projects_list(self):
        self.assertTrue(
            schema_validation.TopLevelProjectsValidator(
                {
                    FieldKeys.PROJECTS: [
